...
public class GlobalBehavior : MonoBehaviour {
    ...
    void Start () {
		...
		HeroBehavior heroBehav = hero.GetComponent<HeroBehavior>();
		...
		for(int i = 0; i < 10; i++){
			GameObject bad = Instantiate(enemy) as GameObject;
			bad.GetComponent<enemyCollision>().heroBe = heroBehav;
			bad.GetComponent<EnemyBehavior>().heroBeha = heroBehav;
		}
        heroBehav.enemyInt = 10; 
		//////////////////////////////////////////////////////////////////////    
